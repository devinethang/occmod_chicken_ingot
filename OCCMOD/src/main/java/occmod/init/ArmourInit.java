...
/** ------------------------------------------------------------------------------------------------------------------------------- **/
    ...
    public static final ArmorMaterial chicken_armour = EnumHelper.addArmorMaterial("chicken_armor", Reference.MOD_ID + ":occ", 
                                                                                                                        999999999,                
                                                                                                                        new int[]{999999999, 999999999, 999999999, 999999999},
                                                                                                                        999999999,
    ...
    public static void init() {
        ...
        chicken_leggings = new CustomArmour("chicken_leggings", chicken_armour, 1, EntityEquipmentSlot.LEGS);
